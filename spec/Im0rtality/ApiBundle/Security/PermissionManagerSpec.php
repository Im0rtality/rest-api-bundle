...
namespace spec\Im0rtality\ApiBundle\Security;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

/**
 * @mixin \Im0rtality\ApiBundle\Security\PermissionManager
 */
class PermissionManagerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Im0rtality\ApiBundle\Security\PermissionManager');
    }
